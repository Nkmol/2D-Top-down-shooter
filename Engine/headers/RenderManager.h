...
public:
	...
	* Draw Text on screen
	*/
	void DrawText(const std::string text, const int x, const int y, int width, int height, const double angle = 0, const int opacity = 255, const int r = 255, const int g = 255, const int b = 255);
